/**
 * Membership package CRUD and catalog for public and admin portals.
 * API: /public/packages, /membership/packages (admin).
 */
...
/**
 * Package listing for public site and admin management, including types and lifecycle operations.
 */
